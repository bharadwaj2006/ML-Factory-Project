...
export function LoginModal({ isOpen, onClose, onSwitchToRegister }: LoginProps) {
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center text-xs text-zinc-500">
                No account? <button onClick={onSwitchToRegister} className="text-hazard font-bold hover:underline">Register here</button>
              </div>
            </form>
          </motion.div>
        </motion.div>
